...
def display_nums(n1,n2,n3,n4,n5):
    print("%d is smaller than %d and %d and %d and %d" % (n1,n2,n3,n4,n5))
    ...
    if c:
        ...
        if c:
            ...
            if c:
                ...
                my_max=n4
    return my_max
def compare_numbers(num_1,num_2,num_3,num_4,num_5):
    if num_1 <= num_2:
        if num_1<=num_3:
            if num_1<=num_4:
                if num_1<=num_5:
...
if __name__=="__main__":
    ...
    num_4=int(num_4)
    num_5=int(num_5)
    compare_numbers(num_1,num_2,num_3,num_4,num_5)
